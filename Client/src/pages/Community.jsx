...
const Community = () => {
  ...
  return (
    <div className='flex-1 h-full gap-4 p-6 flex flex-col'>
      Creations
      <div className='bg-white w-full h-full rounded-xl overflow-y-scroll'>
        {
          creations.map((creation, index) => (
            <div key={index} className='relative group inline-block pl-3 pt-3 w-full sm:max-w-1/2 lg:max-w-1/3'>
              ...
              <div className='absolute bottom-0 right-0 top-0 left-3 flex gap-2 items-end justify-end group-hover:justify-between p-3
